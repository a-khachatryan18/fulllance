...
@section('content')
    <main id = "work_client">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-0 col-lg-5 col-md-pull-5  m-b-120">
                        <h2 class="m-b-30 m-t-70">Easily find quality freelancers</h2>
                        <p>
        ...
        {{-- End find section--}}
        <section class="text-with-image text-with-faq m-t-110" id = "hire" >
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-0 col-lg-5 col-md-offset-1 col-lg-offset-2">
                        <h2 class="m-b-30 m-t-70">Hire the best freelancer</h2>
                        <p>
                            On Fulllance you’ll find a range of top talent, from programmers to designers, writers, customer support reps, and more.
                        </p>
                        <ul>
        ...
        {{--End Work section--}}
        <section class="text-with-image text-with-faq m-t-110" id = "pay">
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 col-md-5 col-md-offset-0 text-center">
                    ...
                    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-0 col-lg-5 col-md-offset-1 col-lg-offset-2">
                        <h2 class="m-b-30 m-t-70">Pay easily, with peace of mind</h2>
                        <p>
                            On Fulllance you’ll find a range of top talent, from programmers to designers, writers, customer support reps, and more.
                        </p>
                        <ul>
        ...
        <section id="hero_signup" class="text-center bg-grass m-t-20" style="border-top:6px solid #999;">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h2>Ready to find a freelancer?</h2>
                        <div class="action_wrapper">
                            <a href="/signup" class="action_btn btn">Get started</a>
                        </div>
                    </div>
                </div>
            </div>
