...
<section id = "fl_settings" class="p-t-20 p-b-70 logged_wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-4 col-xs-12" id = "settings_menu">
                <h4>Billing</h4>
                <ul class="nav nav-pills nav-stacked m-sm-bottom">
                    <li class="{{ (Request::is('payments/billing-methods')) ? 'active' : '' }}">
                        <a href="{{ url('payments/billing-methods') }}">Billing Methods</a>
                    </li>
                </ul>
                <h4>User Settings</h4>
                <ul class="nav nav-pills nav-stacked m-sm-bottom">
                    <li class="{{ (Request::is('membership-connects')) ? 'active' : '' }}">
                        <a href="{{ url('membership-connects') }}">Membership & Connects</a>
                    </li>
                    <li class="{{ (Request::is('freelancer/settings')) ? 'active' : '' }}">
                        <a href="{{ url('freelancer/settings') }}">Contact info</a>
                    </li>
                    <li class="{{ (Request::is('payments/tax-info')) ? 'active' : '' }}">
                        <a href="{{ url('payments/tax-info') }}">Tax Information</a>
                    </li>
                    <li><a href="">My Profile</a></li>
                    <li class="{{ (Request::is('settings/profile')) ? 'active' : '' }}">
                        <a href="{{ url('settings/profile') }}">Profile Settings</a>
                    </li>
                    <li class="{{ (Request::is('payments/disbursement-methods')) ? 'active' : '' }}">
                        <a href="{{ url('payments/disbursement-methods') }}">Get Paid</a>
                    </li>
                    <li class="{{ (Request::is('myteams')) ? 'active' : '' }}">
                        <a href="{{ url('myteams') }}">My Teams</a>
                    </li>
                    <li class="{{ (Request::is('app-authorizations')) ? 'active' : '' }}">
                        <a href="{{ url('app-authorizations') }}">App Authorizations</a>
                    </li>
                    <li class="{{ (Request::is('account-security/password')) ? 'active' : '' }}">
                        <a href="{{ url('account-security/password') }}">Password & Security</a>
                    </li>
                    <li class="{{ (Request::is('notification-settings')) ? 'active' : '' }}">
                        <a href="{{ url('notification-settings') }}">Notification Settings</a>
                    </li>
                </ul>
            </div>
