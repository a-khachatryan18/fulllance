                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="panel panel-default signup_container">
                        ...
                        <div class="panel-body register_content">
                            <div class="row">
                                <form class="form-horizontal" id = "signup_form" role="form" name = "registration" method="POST" action="{{ url('/signup_user') }}">
                                    {{ csrf_field() }}
                                    <div id = "form_step1">
                                    ...
                                    <div id = "form_step2">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <span class="error_message" id = "password-strength-status"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <span class="error_message" id = "terms_error"></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="text-center">
                                                <button type="submit" id = "signup_step2" class="btn btn-success">
                                                    Next
                                                </button>
                                            </div>
                                        </div>
